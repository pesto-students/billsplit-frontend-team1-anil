  ...
  return (
    ...
    <div className='headercontainer'>
        <header className='headeritems'>
            <img className="logo_img" onClick={()=>routeChange("home")} alt="logo" src={Logo}/>
            <ul>
            <li>About US</li>
            <li>FAQs</li>
            <li onClick={()=>routeChange("dashboard")}>Dashboard</li>
            <li onClick={()=>routeChange("login")}>Login/Signin</li>
            </ul>
        </header>
        <div className='mainHeading'>Less stress when sharing expenses with anyone</div>
        <Button id='roughslatebutton' onClick={()=>routeChange("dashboard")} variant="contained">ROUGH SLATE</Button>
    </div>
