        ...
        <div container className="display_statistic_chart">
          <div className="statistic_chart">
            <Grid container justifyContent="center">
                <Grid item xs={12} sm={4} className="item_card" onClick={()=>handleClick('panel1')}><Paper id="paper_total">
                  <span className="item_card_amount">1000</span>
                  <span>Total</span>
                  </Paper>
                </Grid>
                <Grid item xs={6} sm={4} className="item_card" onClick={()=>handleClick('panel2')}><Paper id="paper_owed">
                  <span className="item_card_amount">1000</span>
                  <span>Get Back</span></Paper></Grid>
                <Grid item xs={6} sm={4} className="item_card" onClick={()=>handleClick('panel3')}><Paper id="paper_owe">
                  <span className="item_card_amount">1000</span>
                  <span>Give</span></Paper></Grid>
            </Grid>
          </div>
      </div>
        <div>
